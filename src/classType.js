...
class Calculator extends React.Component {
	...
	render() {
		...
		return (
			<div id="wrapper">
  				<div id="app">
				  	<h1 style={{textAlign:'center'}}><span style={{color:'#fb9717'}}>클레스형</span> 계산기</h1>
					<button type="button" 
						...
						<div className='calculator-keypad'>
							<div className='input-keys'>
								<div className='function-keys'>
									<CalculatorKey className='key-clear' onPress={() => (clearDisplay ? this.clearDisplay() : this.clearAll())}>
										{clearText}
									</CalculatorKey>
